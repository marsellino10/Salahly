...
namespace Salahly.DAL.Migrations
{
    ...
    [Migration("20251124213607_MakeManyPaymentsPerBooking")]
    partial class MakeManyPaymentsPerBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Salahly.DAL.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Salahly.DAL.Entities.Review", b =>
                {
                    ...
                    b.HasOne("ApplicationUser", "Target")
            ...
            modelBuilder.Entity("Salahly.DAL.Entities.ServiceRequest", b =>
                {
                    b.HasOne("Salahly.DAL.Entities.Area", "AreaData")
                        .WithMany()
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
